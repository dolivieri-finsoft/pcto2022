...
router.get('/login', function (req, res) {
  var sql = "SELECT * FROM pcto2022.login where username  = '" + req.query.username + "' and password = '" + req.query.password+ "';";
  console.log(sql);
  conn.query(sql, function (err, result) {
    // if (result.length == 0){
...
//   var sql = "SELECT password FROM pcto2022.login where username = '" + req.query.username + "';";
